...
{
    [TestClass]
    public class SystemNumericComparison_Tests
    {
        ...
        public void Init()
        {
            ...
            _translate345Ref = Matrix4x4.Transpose(Matrix4x4.CreateTranslation(3, 4, 5));
            ...
            _perspFovRef = Matrix4x4.Transpose(Matrix4x4.CreatePerspectiveFieldOfView(fov, aspectRatio, 0.3f, 1000f));
        ...
        [TestMethod]
        public void SystemNumericComparison_Tests_RotationX03()
        {
        ...
        [TestMethod]
        public void SystemNumericComparison_Tests_RotationY03()
        {
        ...
        [TestMethod]
        public void SystemNumericComparison_Tests_RotationZ3()
        {
        ...
        [TestMethod]
        public void SystemNumericComparison_Tests_Scale345()
        {
        ...
        [TestMethod]
        public void SystemNumericComparison_Tests_Translate345()
        {
            Assert.AreEqual(_translate345Ref.M11, _translate345[0][0]);
            Assert.AreEqual(_translate345Ref.M12, _translate345[0][1]);
            Assert.AreEqual(_translate345Ref.M13, _translate345[0][2]);
            Assert.AreEqual(_translate345Ref.M14, _translate345[0][3]);
            Assert.AreEqual(_translate345Ref.M21, _translate345[1][0]);
            Assert.AreEqual(_translate345Ref.M22, _translate345[1][1]);
            Assert.AreEqual(_translate345Ref.M23, _translate345[1][2]);
            Assert.AreEqual(_translate345Ref.M24, _translate345[1][3]);
            Assert.AreEqual(_translate345Ref.M31, _translate345[2][0]);
            Assert.AreEqual(_translate345Ref.M32, _translate345[2][1]);
            Assert.AreEqual(_translate345Ref.M33, _translate345[2][2]);
            Assert.AreEqual(_translate345Ref.M34, _translate345[2][3]);
            Assert.AreEqual(_translate345Ref.M41, _translate345[3][0]);
            Assert.AreEqual(_translate345Ref.M42, _translate345[3][1]);
            Assert.AreEqual(_translate345Ref.M43, _translate345[3][2]);
            Assert.AreEqual(_translate345Ref.M44, _translate345[3][3]);
        }

        [TestMethod]
        public void SystemNumericComparison_Tests_Transform345()
        {
        ...
        {
            Assert.AreEqual(_perspFovRef.M11, _perspFov[0][0]);
            Assert.AreEqual(_perspFovRef.M12, _perspFov[0][1]);
            Assert.AreEqual(_perspFovRef.M13, _perspFov[0][2]);
            Assert.AreEqual(_perspFovRef.M14, _perspFov[0][3]);
            Assert.AreEqual(_perspFovRef.M21, _perspFov[1][0]);
            Assert.AreEqual(_perspFovRef.M22, _perspFov[1][1]);
            Assert.AreEqual(_perspFovRef.M23, _perspFov[1][2]);
            Assert.AreEqual(_perspFovRef.M24, _perspFov[1][3]);
            Assert.AreEqual(_perspFovRef.M31, _perspFov[2][0]);
            Assert.AreEqual(_perspFovRef.M32, _perspFov[2][1]);
            Assert.AreEqual(_perspFovRef.M33, _perspFov[2][2]);
            Assert.AreEqual(_perspFovRef.M34, _perspFov[2][3]);
            Assert.AreEqual(_perspFovRef.M41, _perspFov[3][0]);
            Assert.AreEqual(_perspFovRef.M42, _perspFov[3][1]);
            Assert.AreEqual(_perspFovRef.M43, _perspFov[3][2]);
